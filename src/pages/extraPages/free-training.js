...
import './free-training.css'; // Import the CSS file for styling

function FreeTrainingForm() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (isFormValid) {
      window.location.href = '/ft-coaches'; // Redirect to the tryout schedule page
    }
  };

  return (
    <div className="free-training-form">
